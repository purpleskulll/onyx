    ...
    return (
      <div className="fixed top-0 left-0 z-[101] w-full bg-status-error-01 p-3">
        <Content
          ...
          description="If this is your initial setup or you just updated your Arcamatrix deployment, this is likely because the backend is still starting up. Give it a minute or two, and then refresh the page. If that does not work, make sure the backend is setup and/or contact an administrator."
